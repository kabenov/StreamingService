...
class SearchedMusicAdapter(
    private val onMusicListener: OnMusicListener,
    private val audioPlayer: ExoPlayer
): RecyclerView.Adapter<SearchedMusicItemViewHolder>() {

    private val dataList: MutableList<Music> = mutableListOf()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SearchedMusicItemViewHolder {
        return SearchedMusicItemViewHolder(View.inflate(parent.context, R.layout.music_list_item, null), onMusicListener, audioPlayer)
    }

    override fun onBindViewHolder(holder: SearchedMusicItemViewHolder, position: Int) {
